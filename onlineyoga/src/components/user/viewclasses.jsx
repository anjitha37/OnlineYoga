                ...
                <Col key={yogaClass._id} md={6} lg={4} className="mb-4">
                  ...
                  >
                    <Card.Body>
                      ...
                      <Card.Text><FaCalendarAlt className="me-2" /> <strong>Date:</strong> {new Date(yogaClass.date).toLocaleDateString('en-IN')}</Card.Text>
                      <Card.Text><FaClock className="me-2" /> <strong>Time:</strong> {yogaClass.time}</Card.Text>
                      <Card.Text><strong>Duration:</strong> {yogaClass.duration} mins</Card.Text>
                      <Card.Text><FaUser className="me-2" /><strong>Instructor:</strong> {yogaClass.instructorId?.fullname || "N/A"}</Card.Text>
                      <Card.Text>{yogaClass.description || "No description provided."}</Card.Text>
                      <Card.Text><FaRupeeSign className="me-1" /><strong>Price:</strong> ₹{yogaClass.price}</Card.Text>
